...
class Experience(models.Model):
	...
	def __str__(self):
		if self.type_experience == "pro":
			return f"Experience job is {self.job_title} in company {self.company}."
		else:
			return f"Experience is perso, begin of description is {self.description[:50]}"
